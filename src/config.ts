...
const schema=z.object({
  ...
  WEB_ORIGIN:z.url().default("http://localhost:4173"), PANEL_ORIGIN:optional, PANEL_URL:optional, WEB_HOST:z.string().default("127.0.0.1"),
...
export function loadConfig():Config {
  ...
  config.PANEL_URL ??= config.PANEL_ORIGIN;
